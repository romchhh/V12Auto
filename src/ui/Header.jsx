	...
	return (
		<header className={`${activeStyles} fixed duration-500 z-50 w-full py-3`}>
			<div className='flex justify-between items-center container 2xl:gap-28 relative gap-14'>
				<div className='z-30 relative flex items-end xl:text-4xl text-2xl uppercase font-medium gap-2'>
					<img src='logo.png' alt='logo' className='xl:max-h-20 max-h-14' />
					<span className='xl:py-4 py-2 font-oswald logo'>auto</span>
				</div>
				<div
					className={`flex lg:justify-between flex-1 justify-center items-center lg:relative fixed lg:bg-transparent bg-black flex-col lg:flex-row z-40 w-full h-full top-[-100%] left-0 gap-10 lg:gap-0 duration-500 ${
